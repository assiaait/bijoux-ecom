    ...
    render(){
        return(
            <>
                ...
                <form>
                    <div class="mb-3">
                        <label for="exampleInputEmail1"  style={{color: '#000',maxWidth: '700px',fontSize: '0.8rem',fontWeight:'700'}} className="form-label">Order ID</label>
                    ...
                    <div class="mb-3">
                        <label for="exampleInputPassword1" style={{color: '#000',maxWidth: '700px',fontSize: '0.8rem',fontWeight:'700'}} class="form-label">Billing email</label>
